...
<head>
    ...
    <title>Cetak Resi Identitas</title>
    <style>
        @media print {
            @page {
                size: 10.5cm 15cm;
...
<body onload="window.print();">
    @for ($i = 0; $i < $cari['koli']; $i++)
        <div style="width: 10.5cm; height: 15cm; border: 2px solid black;">
            <div style="display: flex">
                <img src="{{ url('') }}{{ logo_instansi() }}" alt="" width="25%"
                    style="object-fit: contain">
                <h1 style="text-transform: uppercase; text-align: center; color:#363f93; font-size: 25px">
                    {{ nama_instansi() }}</h1>
            </div>
            <div
                style="font-size: 10px; font-style: bold; text-align: left; margin-top: 0px; margin-bottom: 8px; display: flex; ">
            ...
            <div style="padding: 0px 10px; display: flex; justify-content: space-between; text-transform: uppercase; ">
                ...
                <div style="font-size: 27px; text-align: center; width: 80%; text-align: center">
                    {!! QrCode::size(90)->generate($cari['no_resi'] . '-koli' . ($i + 1)) !!}
                </div>
            </div>
