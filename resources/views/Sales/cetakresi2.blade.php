...
<body onload="window.print()">
    ...
    <div style="height: 14cm; width: 19.5cm; margin-bottom: 0.2cm; border-bottom: 1px solid black;">
        ...
        <div style="display: flex; padding: 0px;">
            ...
            <div style="width: 50%;">
                ...
                <table style="color: white; border: 2px solid black; border-collapse: collapse; font-size: 15px;">
                    <tr>
                        <th colspan="3"
                            style="background-color: yellow; border: 2px solid black; font-size: 17px; color: black;">
                            Pembayaran
                        </th>
                    </tr>
                    <tr>
                        <td style="width: 30%; background-color: #28ade7ea; border: 2px solid black">Bea Kirim</td>
                        <td style="width: 30%; border: 2px solid black; background-color: white; color: black">
                            {{ number_format($pengiriman->bea, 0, ',', '.') }}</td>
                        <td style="width: 30%; background-color: #28ade7ea; border: 2px solid black">Total Biaya</td>
                    </tr>
                    <tr>
                        {{-- <td style="background-color: #363f93; border: 2px solid black;">Lainnya</td> --}}
                        <td style="background-color: #28ade7ea; border: 2px solid black;">Lainnya</td>
                    ...
                    <tr>
                        <td style="background-color: #28ade7ea; border: 2px solid black;">Bea Packging</td>
                        <td style="border: 2px solid black; background-color: white; color: black">
                            {{ number_format($pengiriman->bea_packing, 0, ',', '.') }}</td>
                        <td style="background-color: #28ade7ea; border: 2px solid black;">Mode Pembayaran</td>
                    </tr>
                    <tr>
                        {{-- <td style="background-color: #28ade7ea; border: 2px solid black;">Asuransi</td>
                        <td style="border: 2px solid black; background-color: white; color: black">
                            {{ number_format($pengiriman->asuransi, 0, ',', '.') }}</td> --}}
                        <td style="background-color: #28ade7ea; border: 2px solid black;"></td>
                        <td style="background-color: #28ade7ea; border: 2px solid black;"></td>
                        <td style="border: 2px solid black; background-color: white; color: black">
        ...
        <table
            ...
            <tr style="background-color: yellow; color: black;  text-transform: uppercase;">
            ...
            <tr>
                ...
                <td style="border: 2px solid black; background-color: #28ade7ea; color: white">KG</td>
                <td style="border: 2px solid black; background-color: white; color: black">
            ...
            <tr>
                <td style="border: 2px solid black; background-color: #28ade7ea; color: white">M2</td>
                <td style="width: 75px; border: 2px solid black; background-color: white; color: black">
                    {{ number_format($pengiriman->volume, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td style="border: 2px solid black; background-color: yellow; color: black; text-transform: uppercase;">
                    layanan</td>
                <td style="border: 2px solid black;" colspan="3">{{ $pengiriman->nama_pelayanan }}</td>
                <td
                    style="border: 2px solid black; text-transform: uppercase; background-color: red; color: black; text-align: center">
