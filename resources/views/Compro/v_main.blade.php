        ...
        <header>
            ...
            <div class="container">
                ...
                <div class="row nomargin">
                    <div class="span4">
                        <div class="logo">
                            <a href="{{ route('compro') }}"><img style="width: 25%"
                                    src="{{ url('') }}{{ logo_instansi() }}" alt="" /></a>
                        </div>
                    </div>
                    <div class="span8">
                                ...
                                <nav>
                                    <ul class="nav topnav">
                                        <li class="dropdown active">
                                            <a href="{{ route('compro') }}"><i class="icon-home"></i> Beranda</a>
                                        </li>
                                        <li class="dropdown">
                    ...
                    <div class="span6">
                        <div class="widget">
                            ...
                            <address>
                                ...
                                Komplek Pergudangan KA, Jl. Kp. Bandan, RT.2/RW.4, Ancol, Kec. Pademangan, Jakarta
                                Utara, DKI Jakarta, 14430<br>
                            </address>
                            <p>
