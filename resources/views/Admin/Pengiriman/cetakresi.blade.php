...
<body onload="window.print()">
    ...
    <div style="height: 14cm; width: 19.5cm; margin-bottom: 0.2cm; border-bottom: 1px solid black;">
        <div style="display: flex; height: 17%">
            ...
            <div style="text-align: center; width: 75%;">
                <h1 style="text-transform: uppercase; color:#363f93; font-size: 30px; margin: 0px">{{ nama_instansi() }}
                </h1>
                <div style="display: flex; text-align: left;">
                    <div style="width: fit-content; padding: 0px 10px;">
                        <span style="text-decoration: underline;">JAKARTA</span><br>
                        <span style="text-decoration: none; font-size: 11px;">
                            Komplek Jakarta Gudang Jl. Kampung Bandan No. 1 (021)-6914
                        </span>
                    </div>
                    <div style="width: fit-content; padding: 0px 10px;">
                        <span style="text-decoration: underline;">CIREBON</span><br>
                        <span style="text-decoration: none; font-size: 12px;">Stasiun Cirebon (0231)-244601</span>
                    </div>
                    <div style="width: fit-content; padding: 0px 10px;">
                        <span style="text-decoration: underline;">SEMARANG</span><br>
                        <span style="font-size: 12px;">Stasiun Poncol (024)-3560357</span>
                    </div>
                    <div style="width: fit-content; padding: 0px 10px;">
                        <span style="text-decoration: underline;">SURABAYA</span><br>
                        <span style="font-size: 12px;">Jl. Cepu Pintu 7 ...</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; padding: 0px;">
            ...
            <div style="width: 50%;">
                ...
                <table style="color: black; border: 2px solid black; border-collapse: collapse; font-size: 15px;">
                    <tr>
                        <th colspan="3"
                            style="background-color: white; border: 2px solid black; font-size: 17px; color: black;">
                            Pembayaran
                        </th>
                    </tr>
                    <tr>
                        <td style="width: 30%; background-color: white; border: 2px solid black">Bea Kirim</td>
                        <td style="width: 30%; border: 2px solid black; background-color: white; color: black">
                            {{ number_format($pengiriman->bea, 0, ',', '.') }}</td>
                        <td style="width: 30%; background-color: white; border: 2px solid black">Total Biaya</td>
                    </tr>
                    <tr>
                        {{-- <td style="background-color: #363f93; border: 2px solid black;">Lainnya</td> --}}
                        <td style="background-color: white; border: 2px solid black;">Lainnya</td>
                    ...
                    <tr>
                        <td style="background-color: white; border: 2px solid black;">Bea Packging</td>
                        <td style="border: 2px solid black; background-color: white; color: black">
                            {{ number_format($pengiriman->bea_packing, 0, ',', '.') }}</td>
                        <td style="background-color: white; border: 2px solid black;">Mode Pembayaran</td>
                    </tr>
                    <tr>
                        {{-- <td style="background-color: white; border: 2px solid black;">Asuransi</td>
                        <td style="border: 2px solid black; background-color: white; color: black">
                            {{ number_format($pengiriman->asuransi, 0, ',', '.') }}</td> --}}
                        <td style="background-color: white; border: 2px solid black;"></td>
                        <td style="background-color: white; border: 2px solid black;"></td>
                        <td style="border: 2px solid black; background-color: white; color: black">
        ...
        <table
            ...
            <tr style="background-color: white; color: black;  text-transform: uppercase;">
                ...
                <th style="width: 40%; border: 2px solid black; background-color: white; color: black;">keterangan</th>
            </tr>
            <tr>
                ...
                <td style="border: 2px solid black; background-color: white; color: black">KG</td>
                <td style="border: 2px solid black; background-color: white; color: black">
            ...
            <tr>
                <td style="border: 2px solid black; background-color: white; color: black">M2</td>
                <td style="width: 75px; border: 2px solid black; background-color: white; color: black">
                    {{ number_format($pengiriman->volume, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td style="border: 2px solid black; background-color: white; color: black; text-transform: uppercase;">
                    layanan</td>
                <td style="border: 2px solid black;" colspan="3">{{ $pengiriman->nama_pelayanan }}</td>
                <td
                    style="border: 2px solid black; text-transform: uppercase; background-color: white; color: black; text-align: center">
        ...
        <div style="display: flex;">
            <div style="width: 60%; padding-top: 15px">
                ...
                <ol style="font-size: 13px; padding-left: 17px; margin: 0px; height: auto;">
                    ...
                    <li>CUSTOMER SERVICE : wa ({{ wa_instansi() }}), Telp ({{ telp_instansi() }})</li>
    ...
    <div
        ...
        <div style="display: flex; height: 17%">
            <img src="{{ url('') }}{{ logo_instansi() }}" alt="" width="25%"
                style="object-fit: contain">
            <div style="text-align: center; width: 75%;">
                <h1 style="text-transform: uppercase; color:#363f93; font-size: 30px; margin: 0px">
                    {{ nama_instansi() }}
                </h1>
                <div style="display: flex; text-align: left;">
                    <div style="width: fit-content; padding: 0px 10px;">
        ...
        <table
            ...
            <tr style="text-transform: uppercase; background-color: red; color: white;">
                ...
                <th style="width: 30%; border: 2px solid black;">isi barang</th>
                <th style="width: 20%; border: 2px solid black;" colspan="2">berat</th>
                <th style="width: 40%; border: 2px solid black; background-color: white; color: black;">keterangan
                </th>
            </tr>
            <tr>
    ...
    <div class="page-divider" style="margin-bottom: 4cm"></div>
