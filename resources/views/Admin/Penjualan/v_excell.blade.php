        ...
        @foreach ($data as $v)
            <tr>
                ...
                <td style="border: 1px solid black;">
                    {{ number_format($v->kilo, 0, ',', '.') }}
                </td>
                <td style="border: 1px solid black;">{{ $v->koli }}</td>
                <td style="border: 1px solid black;">
                    {{ number_format($v->cash, 0, ',', '.') ?: '' }}
                </td>
                <td style="border: 1px solid black;">
                    {{ number_format($v->cod, 0, ',', '.') ?: '' }}
                </td>
                <td style="border: 1px solid black;">
                    {{ number_format($v->tagihan, 0, ',', '.') ?: '' }}
                </td>
                <td style="border: 1px solid black;">
                    {{ $v->tgl ?: '' }}</td>
    ...
    <tfoot>
        <tr>
            ...
            <td width="90px" style="text-align: right; border: 1px solid black; border-collapse: collapse;">
                <b>{{ number_format($kilo, 0, ',', '.') }}</b>
            </td>
            <td width="90px" style="text-align: right; border: 1px solid black; border-collapse: collapse;">
                <b>{{ number_format($koli, 0, ',', '.') }}</b>
            </td>
            <td width="100px" style="text-align: right; border: 1px solid black; border-collapse: collapse;">
                <b>{{ number_format($cash, 0, ',', '.') }}</b>
            </td>
            <td width="100px" style="text-align: right; border: 1px solid black; border-collapse: collapse;">
                <b>{{ number_format($cod, 0, ',', '.') }}</b>
            </td>
            <td width="100px" style="text-align: right; border: 1px solid black; border-collapse: collapse;">
                <b>{{ number_format($tagihan, 0, ',', '.') }}</b>
            </td>
