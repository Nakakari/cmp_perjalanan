            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row, meta) {
                    ...
                    if (row.is_lunas == 1 && row.nominal_pelunasan != null && row.ttl_biaya_invoice ==
                        ...
                        row.nominal_pelunasan) {
                        tampilan += `
                            <a onclick="updatePelunasan(${row.id_invoice})"  class="ms-3"><i class='bx bxs-edit'></i></a>
                        `;
                    } else if (row.is_lunas == 0 && row.nominal_pelunasan == null) {
                        tampilan += `
                            <a onclick="pelunasan(${row.id_invoice})"  class="ms-3"><i class='bx bxs-edit'></i></a>
                        `;
                    }
                    ...
                    return `<div class="d-flex order-actions">
                        <a href="` + editinvoice +
                        `" ><i class="fadeIn animated bx bx-edit-alt" class="ms-3"></i></a>
                        <a href="` + history + `" class="ms-3"><i class="fadeIn animated bx bx-history"></i></a>
                        <a href="#" class="ms-3"><i class="fadeIn animated bx bx-file"></i></a>` + tampilan + `
                        </div>`;
